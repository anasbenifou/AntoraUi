...
#[derive(Debug)]
pub struct AntoraUiProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AntoraUiProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AntoraUi processing");
    
    let mut processor = AntoraUiProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AntoraUiProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AntoraUiProcessor::new(false);
